...
merc = mapnik.Projection('+proj=aeqd +ellps=sphere +lat_0=90 +lon_0=-'+"77")
...
#centrey, centrex = (46.55734071648642, 15.623558270269896)
...
layer.datasource = mapnik.Ogr(file="/data2/snemanje/miklavz/2017-04-22_15-38-20.gpx",
        layer='tracks')
